...
<?php foreach($supplies as $supply): ?>
	<tr>
		...
		<td>
			...
			<?php if($supply->status=='in-progress'): ?>
			<?php echo html::anchor('admin/supplies/printable.'.$supply->id, 'Pokwitowanie', array('title' => 'Wydrukuj potwierdzenie przyjęcia towaru')) ?>
			<?php endif ?>
		</td>
	</tr>
<?php endforeach ?>
